...
##  [Live Mesh Everywhere: open source and cross-platform](<http://blogs.clariusconsulting.net/kzu/live-mesh-everywhere-open-source-and-cross-platform/> "Live Mesh Everywhere: open source and cross-platform")
...
Let’s get to the more technical details now, and leave the end-user marketing to someone else ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) . 
...
![](http://www.clariusconsulting.net/aggbug.aspx?PostID=61728)
