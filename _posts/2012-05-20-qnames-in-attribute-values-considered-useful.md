...
date: 2012-05-20 00:00:00 +0000
---

##  [QNames in attribute values considered useful](<http://blogs.clariusconsulting.net/kzu/qnames-in-attribute-values-considered-useful/> "QNames in attribute values considered useful")
...
One very clean evidence of this inconsistency around the best practice on QNames on attribute values is the W3C XML Schema specification, which was pretty happy with QNames in attributes:
    ...
    <?xml version="1.0" encoding="utf-8"?><xs:schema targetNamespace="my-schema"               xmlns="my-schema"              xmlns:xs="[http://www.w3.org/2001/XMLSchema"](<http://www.w3.org/2001/XMLSchema%22>)>  <xs:element name="element1" type="xs:string" /></xs:schema>
...
![](http://www.clariusconsulting.net/aggbug.aspx?PostID=28626)
