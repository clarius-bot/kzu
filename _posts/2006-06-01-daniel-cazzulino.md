...
Daniel Cazzulino : eXtensible Mind Lounge : How to add GAX/GAT recipes to arbitrary VS menus
...
[![Microsoft MVP Profile](https://web.archive.org/web/20060613000413im_/http://clariusconsulting.net/Themes/default/images/mvp-logo.gif)](http://aspnet2.com/mvp.ashx?kzu)
...
![Intellisense for GAT command bar element](/web/20060613000413im_/http://clariusconsulting.net/ImageGallery/kzu/GAT/gatmenu1.png)
...
![A recipe in the context menu of a Web Reference](/web/20060613000413im_/http://clariusconsulting.net/ImageGallery/kzu/GAT/gatmenu2.png)
...
posted on Thursday, June 01, 2006 7:32 AM by [kzu](http://clariusconsulting.net/user/Profile.aspx?UserID=1004)

[Post a Comment](http://clariusconsulting.net/blogs/kzu/comments/531.aspx) :: 

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2006/06/01/GATMenus.aspx#532 "permalink") How to add GAX/GAT recipes to arbitrary VS menus @ Thursday, June 01, 2006 7:41 AM

If you're using the Guidance Automation Toolkit, and you want to know how to add recipes to arbitrary... [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl0$EditLink',''\))

[Anonymous](http://clariusconsulting.net/utility/Redirect.aspx?U=http://weblogs.asp.net/cazzu/archive/2006/06/01/How-to-add-GAX_2F00_GAT-recipes-to-arbitrary-VS-menus.aspx "TrackBack")

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2006/06/01/GATMenus.aspx#534 "permalink") re: How to add GAX/GAT recipes to arbitrary VS menus @ Friday, June 02, 2006 10:12 AM

Excellent! Much easier than browsing through CTC files... [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl1$EditLink',''\))

Renaud B&#233;dard

  

[![](/web/20060613000413im_/http://clariusconsulting.net/Themes/default/images/hdr-KZU.jpg)](http://clariusconsulting.net/blogs "Clarius Aggregated Blogs")