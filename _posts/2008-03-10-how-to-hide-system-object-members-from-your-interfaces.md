...
[![image](/img/2008-03-10-4.png)](<http://blogs.clariusconsulting.net/kzu/files/2012/04/image.png>)

A much cleaner intellisense is possible though:

[![image](/img/2008-03-10-1.png)](<http://blogs.clariusconsulting.net/kzu/files/2012/04/image1.png>)
...
Update: a whole lot of projects are leveraging this technique now ![:\)](/img/2008-03-10-2.gif) , pretty much all that have a fluent API. Over time, I’ve started liking the [IFluentInterface](<http://code.google.com/p/autofac/source/browse/src/Source/Autofac/Registrars/IFluentInterface.cs?r=e08de9730494bdb7a6671008094c7edbb4216e03>) name better than my original IHideObjectMembers, but I’ve seen others using [IFluentSyntax](<https://github.com/ninject/ninject/blob/master/src/Ninject/Syntax/IFluentSyntax.cs>) too. If you do leverage this technique, I’d appreciate it if you link to <http://bit.ly/ifluentinterface> in your code documentation ![Smile](/img/2008-03-10-3.png). Thanks!
...
Sometimes I do love VS ![:\)](/img/2008-03-10-2.gif)
