...
##  [Running cleanup powershell command from MSBuild for Team Build Continuous Integration](<http://blogs.clariusconsulting.net/kzu/running-cleanup-powershell-command-from-msbuild-for-team-build-continuous-integration/> "Running cleanup powershell command from MSBuild for Team Build Continuous Integration")
...
BTW, this is going to be [SO much easier with Orcas](<http://channel9.msdn.com/Showpost.aspx?postid=291350> "Channel9 video showing CI in Orcas") ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif)

![](http://www.clariusconsulting.net/aggbug.aspx?PostID=29362)
