...
##  [State Testing vs Interaction Testing](<http://blogs.clariusconsulting.net/kzu/state-testing-vs-interaction-testing/> "State Testing vs Interaction Testing")

December 22, 2007 3:43 am
...
I got the feeling that the article seemed a bit biased towards mockist TDD, only to see in the “So should I be a classicist or a mockist?” section that Fowler himself is a classic TDDer ![:o](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_surprised.gif) ). Maybe it’s because mockist TDD is a newer approach to TDD and therefore required a more extensive explanation. Or maybe it’s just that the article title is a bit misleading as its content is about mocks in the strict sense used by mockists, and not in the general sense I think of them (as generic aids in unit testing).
...
So, if you wonder why [Moq](<http://code.google.com/p/moq/>) doesn’t provide a [Verify](<http://www.clariusconsulting.net/labs/moq/index.html>) method, now you know why ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif) . It’s IMO the most classic/state TDD-friendly mocking library available, and the most [minimalist](<http://www.clariusconsulting.net/labs/moq/index.html>) too ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif) .

![](http://www.clariusconsulting.net/aggbug.aspx?PostID=47166)
