...
##  [Moq 2.5 shipped: lots of good news!](<http://blogs.clariusconsulting.net/kzu/moq-2-5-shipped-lots-of-good-news/> "Moq 2.5 shipped: lots of good news!")
...
As usual, we’d love to hear your feedback at the [discussion list](<http://groups.google.com/group/moqdisc/>) or [issue tracker](<http://code.google.com/p/moq/issues/list>), and patches are always welcome ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif)

![](http://www.clariusconsulting.net/aggbug.aspx?PostID=77643)
