---
layout: post
title: "Daniel Cazzulino's Blog - Joining Xamarin"
...
![](http://cdn.cazzulino.com/vb6.png)[Cross-posted from [my new blog](<http://www.cazzulino.com/hello-xamarin.html> "kzu's new blog")]

Back in 2001 I was making as much money as you could, programming in a language that I had grown to hate: Visual Basic 6.

I remember vividly my first encounter with .NET. I could totally see the upcoming sea change, and how anyone programming in anything but .NET was doomed (well, kinda ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) ). So I became very proficient at C# before it even shipped. I started a couple open source projects, wrote articles, books, presented at conferences and eventually became a Microsoft Most Valuable Professional. An XML MVP even, if you can believe it.

![](http://cdn.cazzulino.com/vs2002.png)  
...
![](http://cdn.cazzulino.com/monkey-300x300.png)  
Exactly a decade after we started, we crossed paths again with Miguel, this time as Xamarin. Without really much effort on his part or [Nat](<https://twitter.com/natfriedman>)’s, I was convinced that another big game changing event is starting. Once again, I believe that anyone programming (mobile apps this time!) in anything but .NET (with Xamarin!) is doomed (well, kinda ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) ). We’ll see about that in due time, for sure!
...
Stay tunned, [this blog](<http://www.cazzulino.com/> "My New Blog Home") is just about to get a lot more active ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif) .
