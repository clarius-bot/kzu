...
##  [Connect to VPN on Vista: This connection requires an active Internet connection](<http://blogs.clariusconsulting.net/kzu/connect-to-vpn-on-vista-this-connection-requires-an-active-internet-connection/> "Connect to VPN on Vista: This connection requires an active Internet connection")
...
![ConnectedOrNot](http://www.clariusconsulting.net/images/blogs/kzu/ConnecttoVPNonVistaThisconnectionrequire_108FD/ConnectedOrNot.png)
...
![image](http://www.clariusconsulting.net/images/blogs/kzu/ConnecttoVPNonVistaThisconnectionrequire_108FD/image.png)
...
![image](http://www.clariusconsulting.net/images/blogs/kzu/ConnecttoVPNonVistaThisconnectionrequire_108FD/image_3.png)
...
![](http://www.clariusconsulting.net/aggbug.aspx?PostID=28104)
