...
date: 2007-12-28 00:00:00 +0000
---

##  [Mocks: by-the-book vs practical](<http://blogs.clariusconsulting.net/kzu/mocks-by-the-book-vs-practical/> "Mocks: by-the-book vs practical")

December 28, 2007 6:18 am

![](http://www.hp-lexicon.org/images/chapters/op/c12--professor-umbridge.jpg)Lately, there’s been some formalization of the definitions of mocks, stubs, fakes and dummies, which Fowler popularized through his site with his article [Mocks aren’t Stubs](<http://martinfowler.com/articles/mocksArentStubs.html>) by introducing the concepts from Gerard Meszaros’ [xUnit patterns book](<http://xunitpatterns.com/>). I haven’t read the book, but the definitions are sensible.
...
Anyway, [happy mocking](<http://code.google.com/p/moq/wiki/QuickStart>) without remorse if you [don’t verify your mocks](<http://www.clariusconsulting.net/blogs/kzu/archive/2007/12/26/48177.aspx>) ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) . It’s all right as long as it gets your (mostly classic) tests green.

![](http://www.clariusconsulting.net/aggbug.aspx?PostID=48594)
