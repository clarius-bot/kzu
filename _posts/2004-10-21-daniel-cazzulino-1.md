...
Daniel Cazzulino : eXtensible Mind Lounge : When a bug that became a really useful feature is fixed: !@#$!@$%@#^%#$%
...
[![Microsoft MVP Profile](https://web.archive.org/web/20060831081138im_/http://clariusconsulting.net/Themes/default/images/mvp-logo.gif)](http://aspnet2.com/mvp.ashx?kzu)
...
The [one bug](http://weblogs.asp.net/cazzu/archive/2004/09/24/BugTure.aspx) I wished was never fixed in VPC has been fixed in SP1. And you need SP1 in order for VPC to run fast in WinXP SP2. Damn!!!!  
  
I'll investigate working with VPC without SP1, and using the addons from Virtual Server 2005, which used to work before....  

posted on Thursday, October 21, 2004 8:12 PM by [kzu](http://clariusconsulting.net/user/Profile.aspx?UserID=1004)

[Post a Comment](http://clariusconsulting.net/blogs/kzu/comments/297.aspx) :: 

  

[![](/web/20060831081138im_/http://clariusconsulting.net/Themes/default/images/hdr-KZU.jpg)](http://clariusconsulting.net/blogs "Clarius Aggregated Blogs")