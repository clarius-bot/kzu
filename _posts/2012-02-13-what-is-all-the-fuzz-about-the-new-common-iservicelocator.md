...
##  [What is all the fuzz about the new common IServiceLocator](<http://blogs.clariusconsulting.net/kzu/what-is-all-the-fuzz-about-the-new-common-iservicelocator/> "What is all the fuzz about the new common IServiceLocator")
...
Oh that’s so wrong ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) . I wish it were that way sometimes, though, hehe.
...
What you might need is to change your DI framework of choice if it doesn’t allow you to get rid of that dependency ![;\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) .  
...
There you have my rant too ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif)

![](http://www.clariusconsulting.net/aggbug.aspx?PostID=99008)
