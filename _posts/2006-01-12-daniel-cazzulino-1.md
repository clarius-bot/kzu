...
Daniel Cazzulino : eXtensible Mind Lounge : I want an im:// protocol handler installed by [my favorite IM application]
...
[![Microsoft MVP Profile](https://web.archive.org/web/20060220124725im_/http://clariusconsulting.net/Themes/default/images/mvp-logo.gif)](http://aspnet2.com/mvp.ashx?kzu)
...
I started doing the same with Skype calls by using the same combination but with `callto://[user]` (if only my buddy [partner](http://clariusconsulting.net/vga) would have a shorter alias instead of [callto://victorgarciaaprea](https://web.archive.org/web/20060220124725/callto://victorgarciaaprea/) ...). 
...
posted on Thursday, January 12, 2006 7:57 PM by [kzu](http://clariusconsulting.net/user/Profile.aspx?UserID=1004)

[Post a Comment](http://clariusconsulting.net/blogs/kzu/comments/442.aspx) :: 

  

![](/web/20060220124725im_/http://clariusconsulting.net/Themes/default/images/hdr-KZU.jpg)