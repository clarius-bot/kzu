...
tags: [ddd, ef, eventsourcing, gadgets, mocking, moq, msbuild, mvc, nuget, patterns, programming, t4, vsx, wcf, webapi]
---
...
![](https://web.archive.org/web/20120204173336im_/http://www.clariusconsulting.net/aggbug.aspx?PostID=115183)

Posted by kzu

![Comments](https://web.archive.org/web/20120204173336im_/http://blogs.clariusconsulting.net/kzu/wp-content/themes/Clarius/style/images/hr.png)

### What do you think?

A name and an email are required. You may use HTML in your comment.

[Click here to cancel reply.](http://blogs.clariusconsulting.net/kzu/evolving-an-api-without-breaking-clients-via-extension-methods-obsoleteattribute-and-editorbrowsableattribute/#respond)
