...
date: 2004-05-14 00:00:00 +0000
---

Daniel Cazzulino : eXtensible Mind Lounge : XSD -& Classes Generator Custom Tool (radically new and extensible)
...
[![Microsoft MVP Profile](https://web.archive.org/web/20060510232433im_/http://clariusconsulting.net/Themes/default/images/mvp-logo.gif)](http://aspnet2.com/mvp.ashx?kzu)
...
posted on Friday, May 14, 2004 11:05 AM by [kzu](http://clariusconsulting.net/user/Profile.aspx?UserID=1004)

[Post a Comment](http://clariusconsulting.net/blogs/kzu/comments/232.aspx) :: 

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2004/05/14/XsdCodeGenTool.aspx#400 "permalink") re: XSD -&amp;amp;amp;gt; Classes Generator Custom Tool (radically new and extensible) @ Tuesday, November 22, 2005 5:08 AM

One issue with any xsd code gen tool, there seems to be no clear mapping between xsd namespaces and .NET namespaces. For example in Java world the excellent xsd2jibx tool converts a xsd namespace like <http://www.ms.com/employees/profile> into the   
package com.employees.profile.   
Why cant we do that in the .NET world as well like   
namespace com.employees.profile{}   
Instead xsd.exe and other code gen tools keeps prompting for the target namespaces.   
Is it possible to fix that by your approach? [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl0$EditLink',''\))

Pradeep Kumar

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2004/05/14/XsdCodeGenTool.aspx#446 "permalink") re: XSD -&amp;amp; Classes Generator Custom Tool (radically new and extensible) @ Wednesday, January 18, 2006 7:10 PM

Is there a way to find wether a node exists in the schema? For example I have a simple schema that has a root and child nodes. I want to know if a child node exists (by name).   
  
For example, a collection object... [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl1$EditLink',''\))

Bob C

  

[![](/web/20060510232433im_/http://clariusconsulting.net/Themes/default/images/hdr-KZU.jpg)](http://clariusconsulting.net/blogs "Clarius Aggregated Blogs")