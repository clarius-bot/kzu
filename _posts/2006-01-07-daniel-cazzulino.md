...
Daniel Cazzulino : eXtensible Mind Lounge : How to reuse Windows Workflow Foundation (WF) cool type browser editor in your components
...
[![Microsoft MVP Profile](https://web.archive.org/web/20060212234555im_/http://clariusconsulting.net/Themes/default/images/mvp-logo.gif)](http://aspnet2.com/mvp.ashx?kzu)
...
![Screenshot of WF type browser in action](https://web.archive.org/web/20060212234555im_/http://aspnet2.com/kzu/weblog/WWFTypeBrowser.png)
...
![Screenshot of the error you get when using the WF type browser](https://web.archive.org/web/20060212234555im_/http://aspnet2.com/kzu/weblog/WWFTypeBrowserError.png)
...
![Screenshot of a working component reusing the WF type browser](https://web.archive.org/web/20060212234555im_/http://aspnet2.com/kzu/weblog/WWFTypeBrowserCustom.png)
...
posted on Saturday, January 07, 2006 12:14 PM by [kzu](http://clariusconsulting.net/user/Profile.aspx?UserID=1004)

[Post a Comment](http://clariusconsulting.net/blogs/kzu/comments/432.aspx) :: 

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2006/01/07/WFTypeBrowser.aspx#434 "permalink") re: How to reuse Windows Workflow Foundation (WWF) cool type browser editor in your components @ Sunday, January 08, 2006 2:23 AM

Cool. But it requires WWF to be installed, right?   
And it still requires to reference WWF assembly, is that ok? [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl0$EditLink',''\))

[Oleg Tkachenko](http://clariusconsulting.net/utility/Redirect.aspx?U=http://www.xmllab.net "Anonymous")

#### [#](http://clariusconsulting.net/blogs/kzu/archive/2006/01/07/WFTypeBrowser.aspx#436 "permalink") re: How to reuse Windows Workflow Foundation (WWF) cool type browser editor in your components @ Monday, January 09, 2006 9:39 AM

Yes, it requires WinFX installed. But, if you're doing WCF/WPF/WWF development, you can use it at all times :). [](javascript:__doPostBack\('_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$_ctl0$Comments$_ctl0$Comments$_ctl1$EditLink',''\))

[kzu](http://clariusconsulting.net/utility/Redirect.aspx?U=http://clariusconsulting.net/kzu "kzu")

  

![](/web/20060212234555im_/http://clariusconsulting.net/Themes/default/images/hdr-KZU.jpg)