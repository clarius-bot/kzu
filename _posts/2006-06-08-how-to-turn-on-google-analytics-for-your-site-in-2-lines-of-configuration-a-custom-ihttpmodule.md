...
If your site is not a high-traffic, performance-sensitive one (i.e. your corporate site/blog/small community site), you may find this little guy useful (note that I only had about 20′ to get it working ![;-\)](/img/2006-06-08-1.gif) ). Download the [module for .NET v.2.0](<http://clariusconsulting.net/kzu/GoogleAnalyticsModule.cs.v2.txt>) or [the one for .NET 1.1](<http://clariusconsulting.net/kzu/GoogleAnalyticsModule.cs.v1.txt>). Configuration is mininal:
