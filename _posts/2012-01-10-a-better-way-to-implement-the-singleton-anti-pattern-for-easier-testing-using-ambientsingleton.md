---
layout: post
title: "Daniel Cazzulino's Blog - A better way to implement the Singleton (anti?) pattern for easier testing using AmbientSingleton pattern for easier testing using AmbientSingleton\")"
