...
tags: [ef, gadgets, moq, msbuild, nuget, programming, t4, vsx, wcf, webapi]
---

##  [Automatic input validation in WPF with data binding and Enterprise Library Validation Application Block](http://blogs.clariusconsulting.net/kzu/automatic-input-validation-in-wpf-with-data-binding-and-enterprise-library-validation-application-block/ "Automatic input validation in WPF with data binding and Enterprise Library Validation Application Block")
...
WPF provides validation infrastructure for databinding scenarios through [ValidationRule](http://msdn2.microsoft.com/en-us/library/ms752347.aspx#validation_process) objects. Only one built-in rule is provided, and you’re expected to write most of these yourself. The way they work is by assigning one or more explicit rules to a binding:
    ...
    <TextBox ...>  <TextBox.Text>    <Binding .>      <Binding.ValidationRules>        <local:JpgValidationRule/>       </Binding.ValidationRules>    </Binding>  </TextBox.Text></TextBox> 
...
The code above specifies that the `FirstName` property must be a non-null, non-empty string. You could very easily create a custom validation rule such as `NotNullOrEmptyValidator`� ![](https://web.archive.org/web/20110905203126im_/http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/) , but you get the idea. 

EntLib VAB provides integration with WinForms and ASP.NET validation architectures, but not for WPF. [Up to now](http://www.codeplex.com/entlibcontrib/Wiki/View.aspx?title=Standalone%20Validation%20Block), that is ![;\)](https://web.archive.org/web/20110905203126im_/http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_wink.gif) . 
...
![](https://web.archive.org/web/20110905203126im_/http://www.clariusconsulting.net/aggbug.aspx?PostID=33083)

Posted by kzu

![Comments](https://web.archive.org/web/20110905203126im_/http://blogs.clariusconsulting.net/kzu/wp-content/themes/Clarius/style/images/hr.png)

### What do you think?

A name and an email are required. You may use HTML in your comment.

[Click here to cancel reply.](http://blogs.clariusconsulting.net/kzu/automatic-input-validation-in-wpf-with-data-binding-and-enterprise-library-validation-application-block/#respond)
