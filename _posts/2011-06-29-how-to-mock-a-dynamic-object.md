...
~~Note that I’m also using the linq to mocks syntax which makes for much more concise and “declarative” way of specifying stub behaviors.~~ That syntax doesn’t work for dynamic properties though, unfortunately ![Sad smile](/img/2011-06-29-2.png), and you’d get the same compile error as before.
