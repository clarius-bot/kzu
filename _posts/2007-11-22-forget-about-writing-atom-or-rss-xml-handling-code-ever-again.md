...
##  [Forget about writing Atom or RSS XML handling code ever again](<http://blogs.clariusconsulting.net/kzu/forget-about-writing-atom-or-rss-xml-handling-code-ever-again/> "Forget about writing Atom or RSS XML handling code ever again")

November 22, 2007 5:02 pm

A *very* welcome addition to .NET 3.5, which just went [RTM for MSDN](<http://www.danielmoth.com/Blog/2007/11/vs2008-rtm-for-non-msdn-subscribers.html>) subscribers and [trial for the rest](<http://msdn2.microsoft.com/en-gb/vstudio/products/aa700831.aspx> "Download VS2008 RTM from MSDN") before general availability early next year: [System.ServiceModel.Syndication](<http://www.clariusconsulting.net/blogs/msdn2.microsoft.com/library/system.servicemodel.syndication.aspx> "MSDN Library").
        ...
        foreach (SyndicationItem item in feed.Items)
        {
            ...
            foreach (SyndicationElementExtension extension in item.ElementExtensions)
            {
                ...
                if (extension.OuterNamespace == Sync.NamespaceUri)
                {
                    ...
                    // IXmlSerializable, so the library figures out it needs one ![:\)](http://blogs.clariusconsulting.net/kzu/wp-includes/images/smilies/icon_smile.gif)
...
So here goes such a factory:
    ...
    /// </remarks>public static class SyndicationFormatterFactory
    {
...
![](http://www.clariusconsulting.net/aggbug.aspx?PostID=42820)
